...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center px-6 pt-24 relative overflow-hidden selection:bg-indigo-500/30">
      {/* Background Ambience */}
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-indigo-600/5 rounded-full blur-[120px] pointer-events-none animate-pulse"></div>
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-violet-600/5 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-xl relative z-10 page-transition">
        <div className="bg-white/[0.02] backdrop-blur-3xl p-12 lg:p-16 rounded-[4rem] border border-white/10 shadow-3xl relative overflow-hidden">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl font-black text-white tracking-tighter mb-4">Initialize Identity.</h1>
            <p className="text-slate-500 font-black uppercase tracking-[0.4em] text-[10px]">Neural Profile Creation Protocol</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            <div className="space-y-4">
              <label className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] ml-2">Full Name (Identifier)</label>
              <input
                type="text"
                value={name}
            ...
            <div className="space-y-4">
              <label className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] ml-2">Secure Link (Email Address)</label>
              <input
                type="email"
                value={email}
            ...
            <div className="pt-6">
              ...
              >
                Establish Neural Link <span className="inline-block ml-2 group-hover:translate-x-2 transition-transform">→</span>
              </button>
            </div>
          </form>
          ...
          <div className="mt-16 text-center">
            <p className="text-slate-600 font-bold text-[10px] uppercase tracking-widest">
              Already Authored?{" "}
              <Link to="/login" className="text-indigo-500 font-black hover:text-white transition-colors underline decoration-indigo-500/30 underline-offset-8">
                De-encrypt Terminal
              </Link>
            </p>
          </div>
        ...
        <div className="mt-12 flex justify-center items-center gap-10 opacity-30 grayscale">
           <p className="text-[8px] font-black text-slate-500 uppercase tracking-[0.5em]">ISO-27001 Certified</p>
           <div className="w-1 h-1 bg-slate-800 rounded-full"></div>
           <p className="text-[8px] font-black text-slate-500 uppercase tracking-[0.5em]">AES-256 Encrypted</p>
           <div className="w-1 h-1 bg-slate-800 rounded-full"></div>
